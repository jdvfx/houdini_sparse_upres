...
#
def copyParmsFolders(sourceNode,destinationNode,parmFolders,reference):
    # sourceNode(node),destinationNode(node),parmFolders(list),reference(Bool)
...
copyParmsFolders(sparsePyro,sopPyroSolver,parmFolders,True)
